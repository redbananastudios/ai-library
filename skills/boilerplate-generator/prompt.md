...
description: Strict scaffolding tool. Generates the exact mandatory boilerplate files for routing, envelope packaging, and handler decoupling BEFORE any logic is written.
---
