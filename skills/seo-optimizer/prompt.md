---
name: seo-optimizer
description: "Comprehensive SEO optimization: full site audits, technical SEO, schema, E-E-A-T, Core Web Vitals, AI search optimization (GEO for AI Overviews/ChatGPT/Perplexity/Claude), programmatic SEO, local SEO, backlinks. Merged from claude-seo + ai-seo + seo-geo-optimizer."
user-invokable: true
