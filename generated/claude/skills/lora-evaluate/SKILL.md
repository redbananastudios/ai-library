...
trigger: evaluate lora, test lora, check lora quality
---
---
name: LoRA Evaluate
description: Generate a test grid from a trained LoRA and score it for consistency, fidelity, overfitting, and artefacts
trigger: when a candidate LoRA has been trained and needs a quality verdict before versioning
---
