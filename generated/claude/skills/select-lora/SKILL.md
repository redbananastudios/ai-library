...
trigger: find lora, match lora, which lora to use
---
---
name: Select LoRA
description: Match best existing LoRA(s) from project registry for a generation request
trigger: when image-router needs to check for applicable LoRAs
---
