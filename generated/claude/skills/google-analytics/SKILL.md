...
trigger: ga4, google analytics, analytics, traffic, sessions, users, conversions, attribution, audience, bounce rate, engagement, revenue tracking, utm, channel performance
---
---
name: google-analytics
description: Query Google Analytics 4 via the Data API for traffic, users, engagement, conversions, attribution and audience insights. Use when the user wants to measure site performance, understand user behaviour, analyse traffic sources, track conversions/revenue, build funnel reports or correlate content changes with traffic deltas.
trigger: ga4, google analytics, analytics, traffic, sessions, users, conversions, attribution, audience, bounce rate, engagement rate, revenue tracking, utm, channel performance, landing pages, funnel, cohort
---
