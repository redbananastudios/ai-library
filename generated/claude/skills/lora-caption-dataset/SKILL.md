...
trigger: caption lora dataset, tag training images, add trigger token
---
---
name: LoRA Caption Dataset
description: Generate or validate captions for a LoRA training dataset with consistent trigger-token usage
trigger: when a prepared LoRA dataset lacks captions or needs caption standardisation
---
