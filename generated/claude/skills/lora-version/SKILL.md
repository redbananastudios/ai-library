...
trigger: version lora, register lora, save lora run metadata
---
---
name: LoRA Version
description: Resolve a final model name, write a registry entry, and assemble full run metadata for a trained and evaluated LoRA
trigger: when a candidate LoRA has been evaluated and needs to be versioned and registered
---
