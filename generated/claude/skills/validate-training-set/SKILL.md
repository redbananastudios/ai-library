...
trigger: validate images for training, check training set, dataset quality
---
---
name: Validate Training Set
description: Check a LoRA training dataset for quality and suitability
trigger: when user provides images for LoRA training
---
