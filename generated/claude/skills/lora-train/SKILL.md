...
trigger: train lora, run lora training, fine-tune lora
---
---
name: LoRA Train
description: Run a LoRA training job against a prepared and captioned dataset, producing a candidate model
trigger: when a validated and captioned dataset is ready to train into a LoRA
---
