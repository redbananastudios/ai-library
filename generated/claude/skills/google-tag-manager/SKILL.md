...
trigger: gtm, tag manager, google tag manager, datalayer, tag, trigger, variable, pixel, conversion tracking, deploy tracking, tracking setup
---
---
name: google-tag-manager
description: Manage Google Tag Manager containers — deploy GA4 events, conversion tracking, advertising pixels and custom events without touching site code. Use when the user wants to set up tracking, add a new conversion, fire a pixel, deploy Meta/LinkedIn/TikTok pixels, configure the dataLayer or manage GTM workspaces.
trigger: gtm, tag manager, google tag manager, datalayer, add tag, add trigger, add variable, deploy pixel, conversion tracking, tracking setup, fire event, meta pixel, linkedin insight tag, tiktok pixel
---
