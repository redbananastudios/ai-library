...
trigger: firecrawl, scrape website, crawl website, extract data from website, web scraping, batch scrape, map urls, scrape page
---
---
name: Firecrawl Web Scraper
description: Scrape, crawl, and extract structured data from websites using the Firecrawl API
trigger: firecrawl, scrape website, crawl website, extract data from website, web scraping, batch scrape, map urls
---
