---
name: api-designer
description: Designs API contracts for REST and GraphQL. Creates versioned endpoints, defines request/response schemas and error models, produces OpenAPI specs and ensures consistency across services.
---
# API Designer
