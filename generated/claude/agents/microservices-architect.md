...
description: Defines microservices architecture. Establishes domain boundaries, communication patterns (event streaming, RPC), service discovery and deployment strategies for scalable systems.
---
